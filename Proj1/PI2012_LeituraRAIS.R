...
dfi <- fread("PI2012_small_50.txt", encoding="UTF-8", dec = ";")
...
#INFLATE TO 2017 VALUES OF BRL (According to IBGE, IPCA index)
df$`Vl Remun Média Nom` <- df$`Vl Remun Média Nom` * 1.4084203
